package net.edufmass.springrecipeapp.bootstrap;

import net.edufmass.springrecipeapp.domain.*;
import net.edufmass.springrecipeapp.repositories.CategoryRepository;
import net.edufmass.springrecipeapp.repositories.RecipeRepository;
import net.edufmass.springrecipeapp.repositories.UnitOfMeasureRepository;
...
public class Bootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        guacRecipe.getIngredients().add(new Ingredient("ripe avocados", new BigDecimal(42), eachUom, guacRecipe));
